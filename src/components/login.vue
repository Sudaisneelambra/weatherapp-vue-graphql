<template>
    <div class="w-full border-2 h-screen bg-gradient-to-r from-[#6ac9f7] to-[#7ee5f5] flex justify-center items-center">
      <div class="md:w-[50%] w-[90%] sm:w-[70%] shadow-lg p-3 flex flex-col items-center border-2 rounded-md">
